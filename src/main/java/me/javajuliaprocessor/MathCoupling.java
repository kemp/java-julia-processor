...
public class MathCoupling {
	...
	public MathCoupling(int t, String s, ValueCoupling o1, ValueCoupling o2) {
		token = t;
		lexeme = s;
		vc1 = o1;
		vc2 = o2;
	}
	public MathCoupling(int t, String s, MathCoupling o1, ValueCoupling o2) {
		token = t;
		lexeme = s;
		mc1 = o1;
		vc2 = o2;
	}
	public MathCoupling(int t, String s, ValueCoupling o1, MathCoupling o2) {
		token = t;
		lexeme = s;
		vc1 = o1;
		mc2 = o2;
	}
	public MathCoupling(int t, String s, MathCoupling o1, MathCoupling o2) {
		token = t;
		lexeme = s;
		mc1 = o1;
		mc2 = o2;
	...
	public void printGrammar() {
		...
		if(vc1 != null && vc2 != null) { // Both objects are ValueCoupling
			...
			System.out.println(lexeme + " -> <arithmetic_op>");
			vc1.printGrammar();
			vc2.printGrammar();
		}
